---
title: "Analysis of Customer Survey Data"
...
* Data Mining  
    + Find missing values and replace them with NA/mean depending on the variable 
    + Create new variables that can improve analysis and enhance visual plots  

*	Visual and Statistical Analysis 
    + Design multiple plots to explain association between variables 
    + Identify dependent, independent and binary variables and analyze their association 
  
*	Predictive Analysis 
    +Use machine learning algorithms to evaluate factors that affect total sale
...
##Questions: 
1.	How well the products are performing and what do customers think of product selection and overall service? 
